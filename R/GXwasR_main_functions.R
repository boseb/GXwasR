...
#'
#' @description
#' This function uses the GWAS summary statistics from sex-stratified tests like "FMstatrified", to evaluate
...
#' "FMstatrified" model with GXWAS function.
#'
#' @param Ffile
#' R dataframe of summary statistics of GWAS or XWAS of male samples with six mandatory columns, SNP(Variant),CHR(Chromosome number),
...
#'
#' In the "FMstatrified" associations are tested separately for males and females, and then the combined p values are computed the Fisher's method, Fisher's method with permutation,
