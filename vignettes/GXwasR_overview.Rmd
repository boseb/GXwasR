...
#> Error in `dev_help()`:
#> ! Can't find development topic `ComputeCorrBT`.
```
...
#> Error in `dev_help()`:
#> ! Can't find development topic `Download_reference`.
```
...
* Tutorial for performing post-imputation QC using GXwasR: [https://boseb.github.io/Processing_1000Genome/tutorial.html](https://boseb.github.io/Processing_1000Genome/tutorial.html)
...
#> 
#>  [1] /private/var/folders/d6/gtwl3_017sj4pp14fbfcbqjh0000gp/T/Rtmp0uzDD3/temp_libpathfc41b4144d
