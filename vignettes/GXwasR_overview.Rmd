...
#> Description:
#> 
#>      This function performs quality control on genetic variant data
#>      from PLINK binary files. It filters variants based on parameters
#>      like minor allele frequency, Hardy-Weinberg equilibrium, call
#>      rate, and differential missingness between cases and controls. It
#>      also handles monomorphic SNPs and applies linkage
#>      disequilibrium-based filtering if specified.
#> 
#> Usage:
#> 
#>      QCsnp(
...
#>           PC 1 and PC2 to the maximum Euclidean distance of the
...
#> 
#>           In the FM01comb and FM01comb methods, associations are tested
#>           separately for males and females with the FM01 and FM02
#>           models, respectively, and then the combined p values are
...
#>           stratified GWAS with FM01comb and FM02comb XWAS models.
#>           Choices are “stouffer.method”, "fisher.method" and
#>           "fisher.method.perm". For fisher.method the function for
#>           combining p-values uses a statistic, S = -2 ∑^k /log p, which
#>           follows a χ^2 distribution with 2k degrees of freedom (Fisher
#>           1925).
#> 
...
#>      tests like FM01comb or FM02comb, to evaluate the difference in
#>      effect size between males and females at each SNP using a t-test.
#> 
...
#>           FM01comb or FM02comb model with GXWAS function.
#> 
...
![plot of chunk overview-QCsample](./overview-QCsample-1.png)
...
#> ✔ Output plink files, Test_output with final samples are in /var/folders/d6/gtwl3_017sj4pp14fbfcbqjh0000gp/T//Rtmp47EYmB.
x$HM
```
...
#> ✔ Output plink files, prefixed as female, are in /var/folders/d6/gtwl3_017sj4pp14fbfcbqjh0000gp/T//Rtmp47EYmB
...
#> /var/folders/d6/gtwl3_017sj4pp14fbfcbqjh0000gp/T//Rtmp47EYmB
x
...
#> ✔ Plink files with passed SNPs are in /var/folders/d6/gtwl3_017sj4pp14fbfcbqjh0000gp/T//Rtmp47EYmB prefixed as PostimputeEX_QC1
#> ✔ Plink files with discarded SNPs are in /var/folders/d6/gtwl3_017sj4pp14fbfcbqjh0000gp/T//Rtmp47EYmB prefixed as PostimputeEX_QC1_snps_extracted
x
#> $PAR
#> NULL
#> 
...
#> ℹ Saving plot to /var/folders/d6/gtwl3_017sj4pp14fbfcbqjh0000gp/T//Rtmp47EYmB/Stratified_GWAS.png
```

![plot of chunk overview-PvalComb](./overview-PvalComb-1.png)

```
#> ℹ Saving plot to /var/folders/d6/gtwl3_017sj4pp14fbfcbqjh0000gp/T//Rtmp47EYmB/Stratified_XWAS.png
```
...
#> ✔ File /private/var/folders/d6/gtwl3_017sj4pp14fbfcbqjh0000gp/T/Rtmp47EYmB/gene.test.score.file.vcf.gz has been created and indexed
#> ℹ 157 genes are having 321 SNPs
#> ! Warning: '/var/folders/d6/gtwl3_017sj4pp14fbfcbqjh0000gp/T//Rtmp47EYmB/cormatrix' already exists
...
#> ℹ You can find them in the directory: /var/folders/d6/gtwl3_017sj4pp14fbfcbqjh0000gp/T//Rtmp47EYmB
#> ✔ Forest plot files for Meta_Analysis.plot SNPs have been created.
#> ℹ You can find them in the directory: /var/folders/d6/gtwl3_017sj4pp14fbfcbqjh0000gp/T//Rtmp47EYmB
x$Resultfixed %>% head()
```
...
|File                                                                          |SNP        |Problem         |
|:-----------------------------------------------------------------------------|:----------|:---------------|
|/private/var/folders/d6/gtwl3_017sj4pp14fbfcbqjh0000gp/T/Rtmp47EYmB/SNPdata_2 |rs2803333  |ALLELE_MISMATCH |
|/private/var/folders/d6/gtwl3_017sj4pp14fbfcbqjh0000gp/T/Rtmp47EYmB/SNPdata_2 |rs672606   |ALLELE_MISMATCH |
|/private/var/folders/d6/gtwl3_017sj4pp14fbfcbqjh0000gp/T/Rtmp47EYmB/SNPdata_2 |rs7519955  |ALLELE_MISMATCH |
|/private/var/folders/d6/gtwl3_017sj4pp14fbfcbqjh0000gp/T/Rtmp47EYmB/SNPdata_2 |rs1538466  |ALLELE_MISMATCH |
|/private/var/folders/d6/gtwl3_017sj4pp14fbfcbqjh0000gp/T/Rtmp47EYmB/SNPdata_2 |rs61777960 |ALLELE_MISMATCH |
|/private/var/folders/d6/gtwl3_017sj4pp14fbfcbqjh0000gp/T/Rtmp47EYmB/SNPdata_2 |rs2865211  |ALLELE_MISMATCH |
...
#> Warning: cannot remove file '/private/var/folders/d6/gtwl3_017sj4pp14fbfcbqjh0000gp/T/Rtmp47EYmB/temp_libpath102934d3db98b', reason 'Directory not empty'
#> ℹ 0.001
...
![plot of chunk compute_prs](./overview-ComputePRS-1.png)
...
#> ✔ GRM has been saved in the file [/var/folders/d6/gtwl3_017sj4pp14fbfcbqjh0000gp/T//Rtmp47EYmB/xGXwasR.grm.bin]
#> ℹ Number of SNPs in each pair of individuals has been saved in the file [/var/folders/d6/gtwl3_017sj4pp14fbfcbqjh0000gp/T//Rtmp47EYmB/xGXwasR.grm.N.bin]
#> 
#> 
#> 
...
| chromosome|Source  |  Variance|        NA|        NA|        NA| SE|
|----------:|:-------|---------:|---------:|---------:|---------:|--:|
|          1|343.88  | 350.43000| 351.09000| 351.29000| 334.23000| NA|
|          1|0.05138 |   0.01988|   0.01092|   0.00000|   0.00000| NA|
|          1|0.00213 |   0.00014|   0.00075|   0.00000|   0.00000| NA|
|          1|0.00469 |  -0.00166|  -0.00286|   0.00000|   0.00000| NA|
|          1|0.18285 |   0.21472|   0.22398|   0.23846|   0.23783| NA|
|          1|0.03878 |   0.04109|   0.04135|   0.03513|   0.02517| NA|
...
#> 
#> Processing chromosome 24
#> ✔ Plots are saved in /var/folders/d6/gtwl3_017sj4pp14fbfcbqjh0000gp/T//Rtmp47EYmB with name Heritability_Plots.jpeg
#> ✔ All GRM related files are in /var/folders/d6/gtwl3_017sj4pp14fbfcbqjh0000gp/T//Rtmp47EYmB
H2 %>% head()
```
...
#> ✔ casesPlink plink files with desired samples are in /var/folders/d6/gtwl3_017sj4pp14fbfcbqjh0000gp/T//Rtmp47EYmB
#> NULL
```
...
#> ✔ Output plink files, prefixed as Test_output, are in /var/folders/d6/gtwl3_017sj4pp14fbfcbqjh0000gp/T//Rtmp47EYmB
x
#> NULL
```
...
PVbyCHR <- FALSE
plinkVCF(DataDir, ResultDir, finput, foutput, VtoP, PtoV, Famfile, PVbyCHR)
#> ✔ Output files created in ResultDir: /var/folders/d6/gtwl3_017sj4pp14fbfcbqjh0000gp/T//Rtmp47EYmB
```
...
#> ✔ Plink files with merged regions are in /var/folders/d6/gtwl3_017sj4pp14fbfcbqjh0000gp/T//Rtmp47EYmB prefixed as Test_output
y
#> NULL
```
...
#> ✔ Plink files with extracted SNPs are in /var/folders/d6/gtwl3_017sj4pp14fbfcbqjh0000gp/T//Rtmp47EYmB prefixed as Filter_Test
#> NULL
```
...
#> ℹ Covariate file: dummycovarfile.cov is in /var/folders/d6/gtwl3_017sj4pp14fbfcbqjh0000gp/T//Rtmp47EYmB
dummy_covars %>% head()
```
...
```
#> ✔ Miami plot of stratified GWAS is saved in /var/folders/d6/gtwl3_017sj4pp14fbfcbqjh0000gp/T//Rtmp47EYmB
```
...
#> Analysis starts on Tue Aug  5 21:32:57 2025
#> ℹ 9339 out of 769306 (1.21%) SNPs in reference panel are available in GWAS 1.
#> ℹ 9327 out of 769306 (1.21%) SNPs in reference panel are available in GWAS 2.
...
#> 
#> 
#> Integrating piecewise resultsError in estimating Genetic Correlation: Algorithm failed to converge after trying different initial values.
#> NULL
```
...
#>  P GXwasR               * 0.99.0     2025-08-06 [?] Bioconductor
...
#> 
#>  [1] /private/var/folders/d6/gtwl3_017sj4pp14fbfcbqjh0000gp/T/Rtmp47EYmB/temp_libpath102935d52cc97
