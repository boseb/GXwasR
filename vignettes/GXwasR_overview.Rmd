...
#> Value:
#> 
#>      A list containing two data frames: one with the IDs of outlier
#>      samples (Outlier_samples), and another with samples annotated with
#>      predicted ancestry (Samples_with_predicted_ancestry).
#> 
#> Author(s):
#> 
#>      Banabithi Bose
...
#> ✔ Output PLINK files, Test_output with final samples are in /var/folders/d6/gtwl3_017sj4pp14fbfcbqjh0000gp/T//Rtmp7SvuuX.
x$HM
```
...
#> ✔ Output PLINK files, prefixed as female, are in /var/folders/d6/gtwl3_017sj4pp14fbfcbqjh0000gp/T//Rtmp7SvuuX
#> This test is running on a case-control dataset with female samples.
#> ℹ Failed SNPs are excluded from the output PLINK files prefixed as Test_output is in /var/folders/d6/gtwl3_017sj4pp14fbfcbqjh0000gp/T//Rtmp7SvuuX
x
...
#> ✔ PLINK files with passed SNPs are in /var/folders/d6/gtwl3_017sj4pp14fbfcbqjh0000gp/T//Rtmp7SvuuX prefixed as PostimputeEX_QC1
#> ✔ PLINK files with discarded SNPs are in /var/folders/d6/gtwl3_017sj4pp14fbfcbqjh0000gp/T//Rtmp7SvuuX prefixed as PostimputeEX_QC1_snps_extracted
x
#> $PAR
#> NULL
#> 
...
#> ℹ Saving plot to /var/folders/d6/gtwl3_017sj4pp14fbfcbqjh0000gp/T//Rtmp7SvuuX/Stratified_GWAS.png
```

![plot of chunk overview-PvalComb](./overview-PvalComb-1.png)

```
#> ℹ Saving plot to /var/folders/d6/gtwl3_017sj4pp14fbfcbqjh0000gp/T//Rtmp7SvuuX/Stratified_XWAS.png
```
...
#> ✔ File /private/var/folders/d6/gtwl3_017sj4pp14fbfcbqjh0000gp/T/Rtmp7SvuuX/gene.test.score.file.vcf.gz has been created and indexed
...
#> ℹ You can find them in the directory: /var/folders/d6/gtwl3_017sj4pp14fbfcbqjh0000gp/T//Rtmp7SvuuX
#> ✔ Forest plot files for Meta_Analysis.plot SNPs have been created.
#> ℹ You can find them in the directory: /var/folders/d6/gtwl3_017sj4pp14fbfcbqjh0000gp/T//Rtmp7SvuuX
x$Resultfixed %>% head()
```
...
|File                                                                          |SNP        |Problem         |
|:-----------------------------------------------------------------------------|:----------|:---------------|
|/private/var/folders/d6/gtwl3_017sj4pp14fbfcbqjh0000gp/T/Rtmp7SvuuX/SNPdata_2 |rs2803333  |ALLELE_MISMATCH |
|/private/var/folders/d6/gtwl3_017sj4pp14fbfcbqjh0000gp/T/Rtmp7SvuuX/SNPdata_2 |rs672606   |ALLELE_MISMATCH |
|/private/var/folders/d6/gtwl3_017sj4pp14fbfcbqjh0000gp/T/Rtmp7SvuuX/SNPdata_2 |rs7519955  |ALLELE_MISMATCH |
|/private/var/folders/d6/gtwl3_017sj4pp14fbfcbqjh0000gp/T/Rtmp7SvuuX/SNPdata_2 |rs1538466  |ALLELE_MISMATCH |
|/private/var/folders/d6/gtwl3_017sj4pp14fbfcbqjh0000gp/T/Rtmp7SvuuX/SNPdata_2 |rs61777960 |ALLELE_MISMATCH |
|/private/var/folders/d6/gtwl3_017sj4pp14fbfcbqjh0000gp/T/Rtmp7SvuuX/SNPdata_2 |rs2865211  |ALLELE_MISMATCH |
...
#> Warning: cannot remove file '/private/var/folders/d6/gtwl3_017sj4pp14fbfcbqjh0000gp/T/Rtmp7SvuuX/temp_libpatheab742dff3cd', reason 'Directory not empty'
#> ℹ 0.001
...
#> ✔ GRM has been saved in the file [/var/folders/d6/gtwl3_017sj4pp14fbfcbqjh0000gp/T//Rtmp7SvuuX/xGXwasR.grm.bin]
#> ℹ Number of SNPs in each pair of individuals has been saved in the file [/var/folders/d6/gtwl3_017sj4pp14fbfcbqjh0000gp/T//Rtmp7SvuuX/xGXwasR.grm.N.bin]
#> 
#> 
#> 
...
#> 
#> Processing chromosome 24
#> ✔ Plots are saved in /var/folders/d6/gtwl3_017sj4pp14fbfcbqjh0000gp/T//Rtmp7SvuuX with name Heritability_Plots.jpeg
#> ✔ All GRM related files are in /var/folders/d6/gtwl3_017sj4pp14fbfcbqjh0000gp/T//Rtmp7SvuuX
H2 %>% head()
```
...
#> ✔ casesPlink PLINK files with desired samples are in /var/folders/d6/gtwl3_017sj4pp14fbfcbqjh0000gp/T//Rtmp7SvuuX
#> NULL
```
...
#> ✔ Output PLINK files, prefixed as Test_output, are in /var/folders/d6/gtwl3_017sj4pp14fbfcbqjh0000gp/T//Rtmp7SvuuX
x
#> NULL
```
...
PVbyCHR <- FALSE
plinkVCF(DataDir, ResultDir, finput, foutput, VtoP, PtoV, Famfile, PVbyCHR)
#> ✔ Output files created in ResultDir: /var/folders/d6/gtwl3_017sj4pp14fbfcbqjh0000gp/T//Rtmp7SvuuX
```
...
#> ✔ Plink files with merged regions are in /var/folders/d6/gtwl3_017sj4pp14fbfcbqjh0000gp/T//Rtmp7SvuuX prefixed as Test_output
y
#> NULL
```
...
#> ✔ Plink files with extracted SNPs are in /var/folders/d6/gtwl3_017sj4pp14fbfcbqjh0000gp/T//Rtmp7SvuuX prefixed as Filter_Test
#> NULL
```
...
#> ℹ Covariate file: dummycovarfile.cov is in /var/folders/d6/gtwl3_017sj4pp14fbfcbqjh0000gp/T//Rtmp7SvuuX
dummy_covars %>% head()
```
...
```
#> ✔ Miami plot of stratified GWAS is saved in /var/folders/d6/gtwl3_017sj4pp14fbfcbqjh0000gp/T//Rtmp7SvuuX
```
...
#> Analysis starts on Wed Aug  6 11:42:35 2025
#> ℹ 9436 out of 769306 (1.23%) SNPs in reference panel are available in GWAS 1.
#> ℹ 9409 out of 769306 (1.22%) SNPs in reference panel are available in GWAS 2.
...
#> 
#>   Bose B, Blostein F, Kim J, Winters J, Actkins KV, Mayer D, Congivaram H, Niarchou M, Edwards DV, Davis LK, Stranger BE (2025). "GXwasR: A Toolkit for Investigating Sex-Differentiated Genetic Effects on Complex Traits." _medRxiv 2025.06.10.25329327_.
#>   doi:10.1101/2025.06.10.25329327 <https://doi.org/10.1101/2025.06.10.25329327>.
#> 
...
#> 
#>  [1] /private/var/folders/d6/gtwl3_017sj4pp14fbfcbqjh0000gp/T/Rtmp7SvuuX/temp_libpatheab742dff3cd
