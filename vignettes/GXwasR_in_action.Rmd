...
vignette: >
  %\VignetteIndexEntry{1. GXwasR in Action}
...
# ftemp <- list.files(ResultDir, pattern = "PostimputeEX_QC3_autopar")
# file.copy(file.path(ResultDir, ftemp), DataDir, overwrite = TRUE))
```
