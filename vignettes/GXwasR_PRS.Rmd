...
```{r, compute_prs, fig.width=10,fig.height=6}
# Running
...
```{r, compute_prs_2, fig.width=10,fig.height=6}
# Running
...
```{r, compute_prs_female, fig.width=10,fig.height=6}
# DataDir <- GXwasR:::GXwasR_data()
ResultDir <- tempdir()
finput <- "femaletarget"
# Filtered discovery data.
...
```{r, compute_prs_male, fig.width=10,fig.height=6}
library(GXwasR)
