...
#> Warning: cannot open file '/var/folders/d6/gtwl3_017sj4pp14fbfcbqjh0000gp/T//RtmpdyNNez/PreimputeEX_QC2.fam': No such file or directory
```
...
![plot of chunk preimpute-QCSample](./preimpute-QCSample-1.png)
...
#> ✔ Output plink files, PreimputeEX_QC4 with final samples are in /var/folders/d6/gtwl3_017sj4pp14fbfcbqjh0000gp/T//RtmpdyNNez.
```
Copying the plink files from ResultDir to DataDir.
...
![plot of chunk preimpute-AncestryCheck](./preimpute-AncestryCheck-1.png)
