...
```{r, meta-manhattan_plot, echo=FALSE, out.width="1500px", out.height="500px", fig.caption = "Manhattan Plot"}
knitr::include_graphics(file.path(ResultDir,"Meta_Analysis.plot.jpeg"))
```

## All Forest plots
Now, let's see all the Forest plots.

```{r, meta-forest_plot1, echo=FALSE, out.width="1000px", out.height="500px", fig.caption = "Forest Plot 1"}
# knitr::include_graphics(file.path(ResultDir,"Meta_Analysis.forest.plot.1.jpg"))
```

```{r, meta-forest_plot2, echo=FALSE, out.width="1000px", out.height="500px", fig.caption = "Forest Plot 2"}
# knitr::include_graphics(file.path(ResultDir,"Meta_Analysis.forest.plot.2.jpg"))
```

```{r, meta-forest_plot3, echo=FALSE, out.width="1000px", out.height="500px", fig.caption = "Forest Plot 3"}
# knitr::include_graphics(file.path(ResultDir,"Meta_Analysis.forest.plot.3.jpg"))
```
